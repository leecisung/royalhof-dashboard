...
# 최종 태그안 v3.3 (2026-08-10 확정 — 토큰 50개 만석, 4개 그룹 공통. 대표키워드는 니치 완점 중 → 유지)
# ★'음식점' 금지: 지도 카테고리 무료노출 영역(돈 낭비). 입력창은 줄바꿈 구분.
_REGION = ["사직", "사직동", "부산사직", "사직역", "사직사거리", "사직야구장", "사직구장",
           "종합운동장", "종합운동장역", "동래", "동래역", "미남역", "거제동", "아시아드",
           "온천장", "연산동", "교대역", "초읍", "명륜동", "동래구"]
_COMMON = ["맛집", "추천", "내돈내산", "근처", "주변", "식당", "전문점", "점심", "런치",
           "저녁", "밥집", "혼밥", "브런치", "포장", "데이트", "회식", "모임", "아이랑",
           "아이와", "가족외식", "먹거리"]
_MENU = ["햄버거", "수제버거", "버거", "치즈버거", "감자튀김", "양식", "레스토랑", "직관", "야구"]
RECOMMEND = {
    "note": ("v3.3 토큰형 50개(한도 만석, 4개 그룹 공통): 앞=지역, 중간=공통, 뒤=메뉴 — 네이버 자유 조합. "
             "'음식점' 제외(지도 카테고리 무료영역). 대표키워드 5개는 유지."),
    "keep_keywords": ["사직야구장햄버거포장", "사직야구장먹거리", "사직동햄버거", "사직동수제버거", "사직구장먹거리"],
    "tags_region": _REGION,
    "tags_common": _COMMON,
    "tags_menu": _MENU,
    "final_tags": _REGION + _COMMON + _MENU,
}
